  ...
  return (
    <div className="bg text__color">
      ...
      <section className="hero ">
        <h1>Welcomet to Veermata Jijabai College of Engineering ,Mumbai Library</h1>
      ...
      <section className="welcome">
        <div className="left">
          ...
          <p>
            Welcome to the Veermata Jijabai College of Engineering ,Mumbai Library Management
            System !
          </p>
          <p>
            ...
            aim of the VJTI Library is to deliver the best print, digital and
